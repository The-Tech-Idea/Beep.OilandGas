...
{
    /// <summary>
    /// Configuration for nodal analysis plot rendering with SkiaSharp.
    /// </summary>
    public class NodalRendererConfiguration
    {
        ...
        // IPR Curve
        public SKColor IPRCurveColor { get; set; } = new SKColor(33, 150, 243); // Blue
        public float IPRCurveLineWidth { get; set; } = 2.5f;
        public bool ShowIPRPoints { get; set; } = false;

        // VLP Curve
        public SKColor VLPCurveColor { get; set; } = new SKColor(255, 87, 34); // Orange
        public float VLPCurveLineWidth { get; set; } = 2.5f;
        public bool ShowVLPPoints { get; set; } = false;
        ...
        public string XAxisLabel { get; set; } = "Flow Rate (BPD)";
        public string YAxisLabel { get; set; } = "Bottomhole Pressure (psi)";
        public string Title { get; set; } = "Nodal Analysis";
