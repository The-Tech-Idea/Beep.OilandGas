    ...
    internal partial class DataManagementService
    {
        ...
        public async Task<object> GetTableMetadataAsync(string tableName, CancellationToken cancellationToken = default)
        {
            ...
            if (AccessMode == ServiceAccessMode.Remote)
                return await GetAsync<object>($"/api/ppdm39metadata/table/{Uri.EscapeDataString(tableName)}", null, cancellationToken);
        ...
        {
            if (AccessMode == ServiceAccessMode.Remote)
                return await GetAsync<List<object>>("/api/ppdm39metadata/tables", null, cancellationToken);
            throw new InvalidOperationException("Local mode not yet implemented");
        }
        ...
        public async Task<object> GetColumnMetadataAsync(string tableName, string columnName, CancellationToken cancellationToken = default)
        {
            ...
            if (AccessMode == ServiceAccessMode.Remote)
                return await GetAsync<object>($"/api/ppdm39metadata/table/{Uri.EscapeDataString(tableName)}/column/{Uri.EscapeDataString(columnName)}", null, cancellationToken);
            throw new InvalidOperationException("Local mode not yet implemented");
        }
