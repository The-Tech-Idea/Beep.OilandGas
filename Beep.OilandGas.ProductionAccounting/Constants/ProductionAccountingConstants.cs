namespace Beep.OilandGas.ProductionAccounting.Constants
{
    ...
    public static class ProductionAccountingConstants
    {
        ...
        // Financial Accounting Constants
        /// <summary>
        ...
        /// Minimum net revenue interest (0%).
        /// </summary>
        public const decimal MinNetRevenueInterestAccounting = 0.0m;

        /// <summary>
        /// Maximum net revenue interest (100%).
        /// </summary>
        public const decimal MaxNetRevenueInterestAccounting = 1.0m;
    ...
    /// <summary>
    /// Constants used in oil and gas accounting calculations (Financial Accounting).
    /// </summary>
