...
namespace Beep.OilandGas.Models.Data.ProductionAccounting
{
    public class CreateRunTicketRequest : ModelEntityBase
    {
...

        {
            ...
            get { return this.DispositionTypeValue.ToString(); }

            set

            {

                if (Enum.TryParse<DispositionType>(value, true, out var parsed))

                    SetProperty(ref DispositionTypeValue, parsed);
        ...
        public DateTime? TICKET_DATE_TIME
