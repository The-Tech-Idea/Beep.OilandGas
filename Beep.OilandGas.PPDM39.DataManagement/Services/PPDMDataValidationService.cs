...
namespace Beep.OilandGas.PPDM39.DataManagement.Services
{
    ...
    public class PPDMDataValidationService : IPPDMDataValidationService
    {
        ...
        /// </summary>
        public async Task<Beep.OilandGas.Models.Data.ValidationResult> ValidateAsync(object entity, string tableName)
        {
            if (entity == null)
            ...
            var result = new Beep.OilandGas.Models.Data.ValidationResult
            {
                Entity = entity,
                TableName = tableName,
                IsValid = true
            ...
            foreach (var rule in rules.Where(r => r.IsActive))
            {
                ...
                if (validationError != null)
                {
                    ...
                    {
                        result.Warnings.Add(new Beep.OilandGas.Models.Data.ValidationWarning
                        {
        ...
        /// </summary>
        public async Task<List<Beep.OilandGas.Models.Data.ValidationResult>> ValidateBatchAsync(IEnumerable<object> entities, string tableName)
        {
            if (entities == null)
                throw new ArgumentNullException(nameof(entities));

            var results = new List<Beep.OilandGas.Models.Data.ValidationResult>();
            var rules = await GetValidationRulesAsync(tableName);
        ...
        /// </summary>
        public async Task<List<Beep.OilandGas.Models.Data.ValidationRule>> GetValidationRulesAsync(string tableName)
        {
        ...
        /// </summary>
        private async Task SaveValidationRuleAsync(Beep.OilandGas.Models.Data.ValidationRule rule, string tableName)
        {
        ...
        /// </summary>
        private Beep.OilandGas.Models.Data.ValidationRule MapToValidationRule(DATA_VALIDATION_RULE entity)
        {
            return new Beep.OilandGas.Models.Data.ValidationRule
            {
        ...
        /// </summary>
        private Beep.OilandGas.Models.Data.ValidationError ValidateRule(ValidationRule rule, object value, object entity, string tableName)
        {
            switch (rule.RuleType)
            {
                case ValidationRuleType.Required:
                    ...
                    {
                        return new Beep.OilandGas.Models.Data.ValidationError
                        {
                            FieldName = rule.FieldName,
