...
**Form templates:** see `Configs/jurisdiction_*.json` in the project and the table in [JURISDICTION_SUPPORT.md](./JURISDICTION_SUPPORT.md) (JSON form configuration). Enum members without a dedicated JSON file may still be used with default validation behavior.
