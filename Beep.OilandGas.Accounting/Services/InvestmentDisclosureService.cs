...
{
    /// <summary>
    /// IFRS 12 disclosure support for interests in other entities.
    /// </summary>
    public class InvestmentDisclosureService
    {
        private readonly IDMEEditor _editor;
        private readonly ICommonColumnHandler _commonColumnHandler;
        private readonly IPPDM39DefaultsRepository _defaults;
        private readonly IPPDMMetadataRepository _metadata;
        private readonly ILogger<InvestmentDisclosureService> _logger;
        private const string ConnectionName = "PPDM39";

        public InvestmentDisclosureService(
            IDMEEditor editor,
            ICommonColumnHandler commonColumnHandler,
            IPPDM39DefaultsRepository defaults,
            IPPDMMetadataRepository metadata,
            ILogger<InvestmentDisclosureService> logger)
        {
            ...
            string? connectionName = null)
        {
            ...
            var cost = new ACCOUNTING_COST
            {
                ...
                FINANCE_ID = entityId ?? "IFRS12_DISCLOSURE",
                COST_TYPE = "IFRS12_DISCLOSURE",
                COST_CATEGORY = "DISCLOSURE",
                AMOUNT = 0m,
                COST_DATE = periodEnd,
            ...
            _logger?.LogInformation("Recorded IFRS 12 disclosure {Entity} {Type}", entityName, disclosureType);
            return cost;
        }
