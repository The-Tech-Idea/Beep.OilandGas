...
namespace Beep.OilandGas.Accounting.Services
{
    public class AnomalyDetectionService
    {
        ...
        public AnomalyDetectionService(IDMEEditor editor, ICommonColumnHandler commonColumnHandler, IPPDM39DefaultsRepository defaults, ILogger<AnomalyDetectionService> logger)
        {
            _editor = editor;
