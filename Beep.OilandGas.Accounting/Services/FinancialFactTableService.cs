...
namespace Beep.OilandGas.Accounting.Services
{
    public class FinancialFactTableService
    {
        ...
        private readonly ILogger<FinancialFactTableService> _logger;
        private readonly IPPDM39DefaultsRepository _defaults;

        public string ConnectionName { get; set; } = "OilandGasDB";

        public FinancialFactTableService(IDMEEditor editor, ICommonColumnHandler commonColumnHandler, IPPDM39DefaultsRepository defaults, ILogger<FinancialFactTableService> logger)
        {
            _editor = editor;
