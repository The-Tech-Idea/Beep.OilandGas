...
namespace Beep.OilandGas.Accounting.Operational.Royalty
{
    /// <summary>
    /// Represents a royalty interest.
    /// </summary>
    public class RoyaltyInterest
    {
        /// <summary>
    ...
    /// <summary>
    /// Represents royalty calculation data.
    /// </summary>
    public class RoyaltyCalculation
    {
        ...
        /// </summary>
        public RoyaltyDeductions Deductions { get; set; } = new();
    ...
    /// </summary>
    public class RoyaltyDeductions
    {
        /// <summary>
    ...
    public class RoyaltyPayment
    {
        ...
        /// </summary>
        public List<TaxWithholding> TaxWithholdings { get; set; } = new();
