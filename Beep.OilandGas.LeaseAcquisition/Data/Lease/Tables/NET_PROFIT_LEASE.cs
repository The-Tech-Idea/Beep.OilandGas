...
namespace Beep.OilandGas.Models.Data.Lease
{
    public partial class NET_PROFIT_LEASE : ModelEntityBase
    {
        ...
        // ── O&G standard NPI fields ──
        private decimal COST_BASISValue;
        public decimal COST_BASIS { get => COST_BASISValue; set => SetProperty(ref COST_BASISValue, value); }

        private string COST_BASIS_OUOMValue = "USD";
        public string COST_BASIS_OUOM { get => COST_BASIS_OUOMValue; set => SetProperty(ref COST_BASIS_OUOMValue, value); }
