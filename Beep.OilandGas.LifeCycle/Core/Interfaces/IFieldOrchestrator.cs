...
namespace Beep.OilandGas.Models.Core.Interfaces
{
    ...
    public interface IFieldOrchestrator
    {
        ...
        /// <summary>
        /// Whether a field is currently active in this orchestrator instance
        /// </summary>
        bool IsFieldActive { get; }
        ...
        /// <summary>
        /// Clear the active field and reset all phase services
        /// </summary>
        ...
        /// <summary>
        /// Get process workflow service for stage-gate and lifecycle process management
        /// </summary>
