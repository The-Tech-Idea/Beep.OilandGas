        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DefaultRoute = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    UserId = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
                    PersonaCode = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                    ViewKey = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    UserId = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
                    PersonaCode = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                    ...
                    UnitSystem = table.Column<string>(type: "character varying(32)", maxLength: 32, nullable: true),
                    DefaultFieldId = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
                    ChangedBy = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
                    ChangedUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    ConcurrencyStamp = table.Column<string>(type: "character varying(36)", maxLength: 36, nullable: false)
                },
