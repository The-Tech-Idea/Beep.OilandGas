        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DefaultRoute = table.Column<string>(type: "NVARCHAR2(256)", maxLength: 256, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActorUserId = table.Column<string>(type: "NVARCHAR2(128)", maxLength: 128, nullable: false),
                    Action = table.Column<string>(type: "NVARCHAR2(32)", maxLength: 32, nullable: false),
                    BeforeJson = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    AfterJson = table.Column<string>(type: "NVARCHAR2(2000)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    UserId = table.Column<string>(type: "NVARCHAR2(128)", maxLength: 128, nullable: false),
                    PersonaCode = table.Column<string>(type: "NVARCHAR2(64)", maxLength: 64, nullable: false),
                    ViewKey = table.Column<string>(type: "NVARCHAR2(128)", maxLength: 128, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    UserId = table.Column<string>(type: "NVARCHAR2(128)", maxLength: 128, nullable: false),
                    PersonaCode = table.Column<string>(type: "NVARCHAR2(64)", maxLength: 64, nullable: true),
                    Locale = table.Column<string>(type: "NVARCHAR2(32)", maxLength: 32, nullable: true),
                    TimeZone = table.Column<string>(type: "NVARCHAR2(128)", maxLength: 128, nullable: true),
                    UnitSystem = table.Column<string>(type: "NVARCHAR2(32)", maxLength: 32, nullable: true),
                    DefaultFieldId = table.Column<string>(type: "NVARCHAR2(128)", maxLength: 128, nullable: true),
                    ChangedBy = table.Column<string>(type: "NVARCHAR2(128)", maxLength: 128, nullable: false),
                    ChangedUtc = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: false),
                    ConcurrencyStamp = table.Column<string>(type: "NVARCHAR2(36)", maxLength: 36, nullable: false)
                },
