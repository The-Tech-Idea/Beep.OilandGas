...
namespace Beep.OilandGas.Repository.Migrations.Oracle
{
    ...
    public partial class InitialRepository : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "ModuleDatabaseBindings",
                columns: table => new
                {
                    ModuleId = table.Column<string>(type: "NVARCHAR2(64)", maxLength: 64, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ModuleDatabaseBindings", x => x.ModuleId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RoleId = table.Column<string>(type: "NVARCHAR2(128)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "NUMBER(10)", nullable: false)
                        .Annotation("Oracle:Identity", "START WITH 1 INCREMENT BY 1"),
                    UserId = table.Column<string>(type: "NVARCHAR2(128)", nullable: false),
                    ClaimType = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    ClaimValue = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                name: "RepositoryBootstrap",
                columns: table => new
                {
                    Id = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    AdministratorUserId = table.Column<string>(type: "NVARCHAR2(128)", maxLength: 128, nullable: false),
                    CompletedAtUtc = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RepositoryBootstrap", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RepositoryBootstrap_AspNet~",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RepositoryBootstrap_Admini~",
                table: "RepositoryBootstrap",
