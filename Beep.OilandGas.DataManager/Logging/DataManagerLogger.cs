...
{
    /// <summary>
    /// Comprehensive logging service for DataManager operations
    /// </summary>
    public class DataManagerLogger
    {
        ...
        public DataManagerLogger(ILogger? logger = null, string? logFilePath = null)
        {
            _logger = logger;
