...
namespace Beep.OilandGas.PPDM39.DataManagement.Tools
{
    ...
    public class PPDMMetadataGenerator
    {
        ...
        private Dictionary<string, PPDMTableMetadata> ParseAllScripts()
        {
            ...
            {
                Console.WriteLine($"  Parsing TAB.sql...");
            ...
            {
                Console.WriteLine($"  Parsing PK.sql...");
            ...
            {
                Console.WriteLine($"  Parsing FK.sql...");
            ...
            foreach (var statement in statements)
            {
                if (IsCreateTableStatement(statement))
                {
                    ...
                    if (tableMeta != null)
                    {
                        ...
                        if (count % 100 == 0)
                        {
                            Console.Write($"    Processed {count} tables...\r");
                        }
                    }
                }
            }
        ...
        private void ParsePrimaryKeys(string sqlScript, Dictionary<string, PPDMTableMetadata> metadata)
        {
            ...
            foreach (var statement in statements)
            {
                ...
                if (match.Success)
                {
                    ...
                    if (count % 100 == 0)
                    {
                        Console.Write($"    Processed {count} primary keys...\r");
                    }
                }
            }
            Console.WriteLine();
        ...
        private void ParseForeignKeys(string sqlScript, Dictionary<string, PPDMTableMetadata> metadata)
        {
            ...
            foreach (var statement in statements)
            {
                ...
                if (match.Success)
                {
                    ...
                    if (count % 500 == 0)
                    {
                        Console.Write($"    Processed {count} foreign keys...\r");
                    }
                }
            }
            Console.WriteLine();
        ...
        private string GenerateCSharpClass(Dictionary<string, PPDMTableMetadata> metadata)
        {
            ...
            sb.AppendLine("// This file is auto-generated by PPDMMetadataGenerator");
            sb.AppendLine("// DO NOT EDIT MANUALLY - Run the generator tool to regenerate");
            ...
            sb.AppendLine("    /// Run GenerateMetadata tool to regenerate");
            sb.AppendLine("    /// </summary>");
            ...
            foreach (var kvp in metadata.OrderBy(x => x.Key))
            {
                ...
                sb.AppendLine($"                PrimaryKeyColumn = {(table.PrimaryKeyColumn != null ? $"\"{table.PrimaryKeyColumn}\"" : "null")},");
                ...
                if (processed % 100 == 0)
                {
                    Console.Write($"    Generating C# code: {processed}/{metadata.Count} tables...\r");
                }
            }
            Console.WriteLine();
