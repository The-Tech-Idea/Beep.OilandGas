...
private  System.String SOURCEValue; 
        ...
        // --- O&G best-practice additions (Rock-Eval geochemistry) ---

        private System.Decimal? S1Value;
        /// <summary>Rock-Eval S1 parameter: free hydrocarbons (mg HC/g rock).</summary>
        public System.Decimal? S1
        {
            get { return this.S1Value; }
            set { SetProperty(ref S1Value, value); }
        }

        private System.Decimal? S2Value;
        /// <summary>Rock-Eval S2 parameter: remaining generation potential (mg HC/g rock).</summary>
        public System.Decimal? S2
        {
            get { return this.S2Value; }
            set { SetProperty(ref S2Value, value); }
        }

        private System.Decimal? S3Value;
        /// <summary>Rock-Eval S3 parameter: CO2 yield (mg CO2/g rock).</summary>
        public System.Decimal? S3
        {
            get { return this.S3Value; }
            set { SetProperty(ref S3Value, value); }
        }

        private System.Decimal? THICKNESSValue;
        /// <summary>Source rock interval thickness.</summary>
        ...
        private System.String THICKNESS_OUOMValue;
        public System.String THICKNESS_OUOM
        {
            get { return this.THICKNESS_OUOMValue; }
            set { SetProperty(ref THICKNESS_OUOMValue, value); }
        }
