...
private  System.String SOURCEValue; 
        ...
        // --- O&G best-practice additions (SPE PRMS probability of success) ---

        private System.Decimal? CHARGE_RISKValue;
        /// <summary>Hydrocarbon charge/migration risk factor (0.0–1.0). Separate from source-rock risk.</summary>
        public System.Decimal? CHARGE_RISK
        {
            get { return this.CHARGE_RISKValue; }
            set { SetProperty(ref CHARGE_RISKValue, value); }
        }

        private System.Decimal? POS_GEOLOGICALValue;
        /// <summary>Probability of Geological Success (0.0–1.0) = product of all geological risk factors.</summary>
        public System.Decimal? POS_GEOLOGICAL
        {
            get { return this.POS_GEOLOGICALValue; }
            set { SetProperty(ref POS_GEOLOGICALValue, value); }
        }

        private System.Decimal? POS_COMMERCIALValue;
        /// <summary>Probability of Commercial Success (0.0–1.0) = geological success AND commercial viability.</summary>
        public System.Decimal? POS_COMMERCIAL
        {
            get { return this.POS_COMMERCIALValue; }
            set { SetProperty(ref POS_COMMERCIALValue, value); }
        }

        private System.Decimal? POS_OVERALLValue;
        /// <summary>Overall Probability of Success = POS_GEOLOGICAL × POS_COMMERCIAL. Used in EMV = (PoS × NPV_success) − ((1−PoS) × Exploration_Cost).</summary>
        public System.Decimal? POS_OVERALL
        {
            get { return this.POS_OVERALLValue; }
            set { SetProperty(ref POS_OVERALLValue, value); }
        }
