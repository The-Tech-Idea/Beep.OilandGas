...
| `Beep.OilandGas.ProspectIdentification.Services.IExplorationApplicationService` | **Roadmap** only; **`[Obsolete]`**; not registered — **region map:** `.plans/10_IExplorationApplicationService_Region_Map.md` |
...
| `Beep.OilandGas.ProspectIdentification.Tests` | **`ProspectIdentificationService`** mapping + analysis + **validation** (argument guards before repository use) |
