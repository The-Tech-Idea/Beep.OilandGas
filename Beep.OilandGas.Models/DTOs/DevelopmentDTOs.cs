...
namespace Beep.OilandGas.Models.DTOs
{
    ...
    /// </summary>
    public class DevelopmentWellRequest
    {
    ...
    /// </summary>
    public class DevelopmentWellResponse
    {
    ...
    /// </summary>
    public class FeasibilityStudyRequest
    {
        public string? FieldId { get; set; }
    ...
    /// </summary>
    public class FeasibilityProductionPoint
    {
    ...
    /// </summary>
    public class FeasibilityStudyResponse
    {
    ...
    /// </summary>
    public class FeasibilityCashFlowPoint
    {
        public int Year { get; set; }
