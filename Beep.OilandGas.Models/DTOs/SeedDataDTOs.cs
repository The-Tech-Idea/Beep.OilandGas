...
namespace Beep.OilandGas.Models.DTOs
{
    ...
    /// </summary>
    public class SeedDataValidationRequest
    {
    ...
    /// </summary>
    public class WorkflowSeedDataRequirement
    {
    ...
    public class LOVResponse
    {
        public bool Success { get; set; }
        public string Message { get; set; } = string.Empty;
        public List<ListOfValueDto> LOVs { get; set; } = new List<ListOfValueDto>();
    ...
    public class ListOfValueDto
    {
        ...
        public string? Source { get; set; }
        public List<ListOfValueDto>? Children { get; set; }
    }

    /// <summary>
    /// Response from RA_* tables extraction operation
    /// </summary>
    public class RATablesExtractResponse
    {
        public bool Success { get; set; }
        public string Message { get; set; } = string.Empty;
    ...
    /// </summary>
    public class RATablesExportRequest
    {
        public string? OutputPath { get; set; }
    }
}
