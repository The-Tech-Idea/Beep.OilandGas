...
namespace Beep.OilandGas.Models.DTOs.ProductionAccounting
{
    ...
    public class ExchangeContractDto
    {
        ...
        /// </summary>
        public ExchangeTermsDto Terms { get; set; } = new();

        /// <summary>
        /// Gets or sets the delivery points.
        /// </summary>
        public List<ExchangeDeliveryPointDto> DeliveryPoints { get; set; } = new();

        /// <summary>
        /// Gets or sets the pricing terms.
        /// </summary>
        public ExchangePricingTermsDto PricingTerms { get; set; } = new();
    }

    /// <summary>
    /// Represents a party to an exchange contract.
    /// </summary>
    public class ExchangePartyDto
    {
        /// <summary>
    ...
    /// </summary>
    public class ExchangeDeliveryPointDto
    {
        /// <summary>
    ...
    /// </summary>
    public class ExchangePricingTermsDto
    {
        /// <summary>
    ...
    /// </summary>
    public class ExchangeCommitmentDto
    {
        /// <summary>
