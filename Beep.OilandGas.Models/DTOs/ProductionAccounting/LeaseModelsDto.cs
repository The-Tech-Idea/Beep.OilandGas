...
namespace Beep.OilandGas.Models.DTOs.ProductionAccounting
{
    ...
    /// </summary>
    public abstract class LeaseAgreementDto
    {
        /// <summary>
        ...
        /// </summary>
        public LeaseProvisionsDto Provisions { get; set; } = new();

        /// <summary>
        /// Gets or sets the location information.
        /// </summary>
        public LeaseLocationDto Location { get; set; } = new();
    }

    /// <summary>
    /// Fee (private) mineral estate lease.
    /// </summary>
    public class FeeMineralLeaseDto : LeaseAgreementDto
    {
        /// <summary>
    ...
    /// </summary>
    public class GovernmentLeaseDto : LeaseAgreementDto
    {
        /// <summary>
    ...
    /// Net profit interest lease.
    /// </summary>
    public class NetProfitLeaseDto : LeaseAgreementDto
    {
        /// <summary>
        ...
        /// </summary>
        public NetProfitCostRecoveryDto CostRecovery { get; set; } = new();

        public NetProfitLeaseDto()
        {
    ...
    /// Joint interest lease (joint operating agreement).
    /// </summary>
    public class JointInterestLeaseDto : LeaseAgreementDto
    {
        /// <summary>
        ...
        /// </summary>
        public List<JointInterestParticipantDto> Participants { get; set; } = new();
    ...
    /// </summary>
    public class LeaseProvisionsDto
    {
        /// <summary>
    ...
    /// </summary>
    public class NetProfitCostRecoveryDto
    {
        /// <summary>
    ...
    /// </summary>
    public class JointInterestParticipantDto
    {
        /// <summary>
