...
namespace Beep.OilandGas.Models.DTOs.ProductionAccounting
{
    ...
    public class OwnerInformationDto
    {
        ...
        /// </summary>
        public ContactInformationDto? Contact { get; set; }
    }
    ...
    public class TransferOrderDto
    {
        ...
        /// </summary>
        public OwnerInformationDto FromOwner { get; set; } = new();

        /// <summary>
        /// Gets or sets the to owner.
        /// </summary>
        public OwnerInformationDto ToOwner { get; set; } = new();
    ...
    /// </summary>
    public class OwnershipInterestDto
    {
        /// <summary>
