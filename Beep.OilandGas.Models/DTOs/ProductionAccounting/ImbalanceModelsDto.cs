...
namespace Beep.OilandGas.Models.DTOs.ProductionAccounting
{
    ...
    /// </summary>
    public class ProductionAvailsDto
    {
        /// <summary>
        ...
        /// </summary>
        public List<AvailsAllocationDto> Allocations { get; set; } = new();
    }

    /// <summary>
    /// Represents an avails allocation.
    /// </summary>
    public class AvailsAllocationDto
    {
        /// <summary>
    ...
    /// </summary>
    public class ImbalanceStatementDto
    {
        /// <summary>
        ...
        /// </summary>
        public ImbalanceSummaryDto Nominations { get; set; } = new();

        /// <summary>
        /// Gets or sets the actuals summary.
        /// </summary>
        public ImbalanceSummaryDto Actuals { get; set; } = new();

        /// <summary>
        /// Gets or sets the imbalances.
        /// </summary>
        public List<OilImbalanceDto> Imbalances { get; set; } = new();

        /// <summary>
        /// Gets or sets the reconciliation details.
        /// </summary>
        public ImbalanceReconciliationDto? Reconciliation { get; set; }
    }

    /// <summary>
    /// Represents an imbalance summary.
    /// </summary>
    public class ImbalanceSummaryDto
    {
        /// <summary>
    ...
    /// </summary>
    public class ImbalanceReconciliationDto
    {
        /// <summary>
    ...
    /// </summary>
    public class ImbalanceAdjustmentDto
    {
        /// <summary>
