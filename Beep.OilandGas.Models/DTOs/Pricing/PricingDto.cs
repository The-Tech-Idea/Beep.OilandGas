...
namespace Beep.OilandGas.Models.DTOs.Pricing
{
    ...
    public class CreatePriceIndexRequest
    {
        public string IndexName { get; set; }
    ...
    public class PricingReconciliationRequest
    {
        public string RunTicketNumber { get; set; }
    ...
    public class PricingReconciliationResult
    {
    ...
    public class PricingApprovalResult
    {
        public string ValuationId { get; set; }
