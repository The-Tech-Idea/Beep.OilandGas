...
namespace Beep.OilandGas.Models.DTOs.Calculations
{
    ...
    /// </summary>
    public class WellPluggingPlanDto
    {
    ...
    /// </summary>
    public class DecommissioningCostAnalysisDto
    {
        public string WellUWI { get; set; }
        public double WellDepth { get; set; }
    ...
    /// </summary>
    public class EnvironmentalRemediationAnalysisDto
    {
        public string WellUWI { get; set; }
        public string Location { get; set; }
        public DateTime AnalysisDate { get; set; }
    ...
    /// </summary>
    public class RegulatoryComplianceAnalysisDto
    {
        public string WellUWI { get; set; }
    ...
    /// </summary>
    public class SalvageValueAnalysisDto
    {
        public string WellUWI { get; set; }
        public string WellType { get; set; }
        public double WellDepth { get; set; }
    ...
    /// </summary>
    public class DecommissioningScheduleDto
    {
        public string WellUWI { get; set; }
        public double WellDepth { get; set; }
        ...
        public DateTime AnalysisDate { get; set; }
        public List<DecommissioningPhaseDto> ProjectPhases { get; set; } = new();
    ...
    /// </summary>
    public class DecommissioningPhaseDto
    {
    ...
    /// </summary>
    public class AbandonmentFeasibilityDto
    {
        public string WellUWI { get; set; }
        public double WellDepth { get; set; }
    ...
    /// </summary>
    public class PortfolioDecommissioningAnalysisDto
    {
        public string FieldId { get; set; }
        public int WellsToDecommission { get; set; }
        public DateTime AnalysisDate { get; set; }
        public List<PortfolioWellDecommissioningDto> WellAnalyses { get; set; } = new();
        public double TotalEstimatedCost { get; set; }
    ...
    /// </summary>
    public class PortfolioWellDecommissioningDto
    {
        public string WellUWI { get; set; }
        public double WellDepth { get; set; }
