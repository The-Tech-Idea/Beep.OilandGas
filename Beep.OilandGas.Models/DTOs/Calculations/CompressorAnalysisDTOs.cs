...
namespace Beep.OilandGas.Models.DTOs.Calculations
{
    ...
    /// </summary>
    public class CompressorPerformanceDto
    {
    ...
    /// </summary>
    public class CompressorDesignDto
    {
        ...
        public List<CompressorStageDto> Stages { get; set; } = new();
    }

    /// <summary>
    /// DTO for individual compressor stage
    /// </summary>
    public class CompressorStageDto
    {
    ...
    /// </summary>
    public class CentrifugalCompressorAnalysisDto
    {
        public string AnalysisId { get; set; } = string.Empty;
        public DateTime AnalysisDate { get; set; }
    ...
    /// </summary>
    public class ReciprocationCompressorAnalysisDto
    {
        public string AnalysisId { get; set; } = string.Empty;
        public DateTime AnalysisDate { get; set; }
    ...
    /// </summary>
    public class CompressorEfficiencyAnalysisDto
    {
        public string AnalysisId { get; set; } = string.Empty;
        public DateTime AnalysisDate { get; set; }
        public decimal IsentropicEfficiency { get; set; }
    ...
    /// </summary>
    public class CompressorMaintenancePredictionDto
    {
    ...
    /// </summary>
    public class CompressorPressureFlowAnalysisDto
    {
        public string AnalysisId { get; set; } = string.Empty;
        public DateTime AnalysisDate { get; set; }
        public List<PressureFlowPointDto> PerformancePoints { get; set; } = new();
    ...
    /// </summary>
    public class PressureFlowPointDto
    {
    ...
    /// </summary>
    public class CompressorPowerAnalysisDto
    {
        public string AnalysisId { get; set; } = string.Empty;
        public DateTime AnalysisDate { get; set; }
