...
namespace Beep.OilandGas.Models.DTOs.Calculations
{
    ...
    public class GenerateForecastRequest
    {
        ...
        /// </summary>
        public List<CapitalScheduleItemDto> CapitalSchedule { get; set; } = new();
    }
    ...
    public class DeclineCurveAnalysisDto
    {
        ...
        /// </summary>
        public List<ProductionDataPointDto> HistoricalData { get; set; } = new();
    }

    /// <summary>
    /// Production data point for analysis
    /// </summary>
    public class ProductionDataPointDto
    {
        /// <summary>
        /// Production date
        /// </summary>
    ...
    /// </summary>
    public class ProbabilisticForecastDto
    {
        /// <summary>
        /// Forecast ID
        /// </summary>
        ...
        /// </summary>
        public ProductionForecastResultDto P10Forecast { get; set; } = new();

        /// <summary>
        /// P50 case forecast (most likely)
        /// </summary>
        public ProductionForecastResultDto P50Forecast { get; set; } = new();

        /// <summary>
        /// P90 case forecast (high case)
        /// </summary>
        public ProductionForecastResultDto P90Forecast { get; set; } = new();

        /// <summary>
        /// Expected value forecast
        /// </summary>
        public ProductionForecastResultDto ExpectedForecast { get; set; } = new();

        /// <summary>
        /// Risk analysis results
        /// </summary>
        public RiskAnalysisResultDto RiskAnalysis { get; set; } = new();
    }
    ...
    public class EconomicAnalysisDto
    {
        ...
        /// </summary>
        public List<CashFlowPointDto> CashFlows { get; set; } = new();
    }

    /// <summary>
    /// Capital schedule item for CAPEX by date
    /// </summary>
    public class CapitalScheduleItemDto
    {
        public DateTime Date { get; set; }
