...
namespace Beep.OilandGas.Models.Data
{
    ...
    public class Prospect : ModelEntityBase
    {
        ...
        public List<SeismicSurvey> SeismicSurveys { get; set; } = new();
        public ProspectEvaluation? Evaluation { get; set; }
    }
    ...
    /// </summary>
     ...
     public class ProspectRanking : ModelEntityBase
     {
         ...
         public List<CriteriaScoring> CriteriaScores { get; set; } = new();
     }
