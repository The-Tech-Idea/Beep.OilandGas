...
{
    public class CreateRoyaltyInterestRequest : ModelEntityBase
    {
    ...
    public class CreateRoyaltyStatementRequest : ModelEntityBase
    {
        public string RoyaltyOwnerBaId { get; set; }
        public string PropertyId { get; set; }
    ...
    public class RoyaltyOwnerSummary : ModelEntityBase
    {
    ...
    public class RoyaltyPaymentApprovalResult : ModelEntityBase
    {
    ...
    public class RoyaltyAuditTrail : ModelEntityBase
    {
