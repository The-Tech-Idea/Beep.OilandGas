...
namespace Beep.OilandGas.Models.Data.Calculations
{
    ...
    public class ChokeSystemComprehensiveReport : ModelEntityBase
    {
        ...
        // Current conditions
        public AdvancedChokeAnalysis CurrentChokeAnalysis { get; set; } = new();
        public ChokePerformanceDiagnostics PerformanceDiagnostics { get; set; } = new();
        public ChokeErosionPrediction ErosionPrediction { get; set; } = new();
        public ChokeSandCutRiskAssessment SandRiskAssessment { get; set; } = new();
        
        // Optimization
        public ChokeBackPressureOptimization OptimizationAnalysis { get; set; } = new();
        public ChokeProductionForecast ProductionForecast { get; set; } = new();
        
        // Equipment
        public ChokeTrimSelection EquipmentRecommendation { get; set; } = new();
