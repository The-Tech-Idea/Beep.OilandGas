raiserror ('CREATING TABLE JURISDICTION_REQUIREMENTS', 10,1) with nowait

CREATE TABLE JURISDICTION_REQUIREMENTS
(
    JURISDICTION_REQUIREMENTS_ID NVARCHAR(40) NOT NULL,
    COUNTRY NVARCHAR(255),
    STATE_PROVINCE NVARCHAR(255),
    REGULATORY_AUTHORITY NVARCHAR(255),
    REQUIREMENTS_DESCRIPTION NVARCHAR(2000),
