raiserror ('CREATING TABLE NODAL_IPR_POINT', 10,1) with nowait

CREATE TABLE NODAL_IPR_POINT
(
    NODAL_IPR_POINT_ID NVARCHAR(40) NOT NULL,
    NODAL_ANALYSIS_ID NVARCHAR(40),
    FLOW_RATE NUMERIC(18,2),
    FLOWING_BOTTOMHOLE_PRESSURE NUMERIC(18,2),
