raiserror ('CREATING TABLE GOVERNMENTAL_TAX_DATA', 10,1) with nowait

CREATE TABLE GOVERNMENTAL_TAX_DATA
(
    GOVERNMENTAL_TAX_DATA_ID NVARCHAR(40) NOT NULL,
    SEVERANCE_TAX NUMERIC(18,2),
    AD_VALOREM_TAX NUMERIC(18,2),
