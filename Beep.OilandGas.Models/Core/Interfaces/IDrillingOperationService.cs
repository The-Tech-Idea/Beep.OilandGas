...
namespace Beep.OilandGas.Models.Core.Interfaces
{
    ...
    public interface IDrillingOperationService
    {
        ...
        Task<List<DRILLING_OPERATION>> GetDrillingOperationsAsync(string? wellUWI = null, string? fieldId = null);
        ...
        Task<DRILLING_OPERATION?> GetDrillingOperationAsync(string operationId, string? fieldId = null);
        ...
        Task<DRILLING_OPERATION> CreateDrillingOperationAsync(CREATE_DRILLING_OPERATION createDto, string? fieldId = null, string? userId = null);
        ...
        Task<DRILLING_OPERATION> UpdateDrillingOperationAsync(string operationId, UpdateDrillingOperation updateDto, string? fieldId = null, string? userId = null);
        ...
        Task<List<DRILLING_REPORT>> GetDrillingReportsAsync(string operationId, string? fieldId = null);
        ...
        Task<DRILLING_REPORT> CreateDrillingReportAsync(string operationId, CreateDrillingReport createDto, string? fieldId = null, string? userId = null);
    }
}
