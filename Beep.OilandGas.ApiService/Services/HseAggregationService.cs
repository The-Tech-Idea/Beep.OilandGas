...
using Beep.OilandGas.PPDM39.Core.Metadata;using Beep.OilandGas.PPDM39.Repositories;
...
namespace Beep.OilandGas.ApiService.Services
{
    public class HseAggregationService
    {
        ...
        private readonly string _connectionName;private readonly ILogger<HseAggregationService> _logger;
        ...
        public async Task<IncidentSummary> GetIncidentSummaryAsync(string? fieldId=null,DateTime? start=null,DateTime? end=null)
        {
            ...
            try{
                var repo=GetRepo<Beep.OilandGas.Models.Data.HSE.HSE_INCIDENT>("HSE_INCIDENT");
                ...
                var entities=(await repo.GetAsync(f)).OfType<Beep.OilandGas.Models.Data.HSE.HSE_INCIDENT>().ToList();
                r.Total=entities.Count;
                r.Tier1=entities.Count(e=>string.Equals(e.INCIDENT_TIER,"TIER_1",StringComparison.OrdinalIgnoreCase));
                r.Tier2=entities.Count(e=>string.Equals(e.INCIDENT_TIER,"TIER_2",StringComparison.OrdinalIgnoreCase));
                r.ByType=entities.GroupBy(e=>e.INCIDENT_TYPE??"UNKNOWN").ToDictionary(g=>g.Key,g=>g.Count());
