...
{
    #region Accounting Service Interface
    ...
    public interface IAccountingService
    {
        ...
        /// </summary>
        Task<List<ROYALTY_CALCULATION>> GetRoyaltyCalculationsAsync(string? fieldId = null, string? poolId = null, DateTime? startDate = null, DateTime? endDate = null, List<AppFilter>? additionalFilters = null);
    ...
    /// </summary>
    public class VolumeReconciliationResult
    {
    ...
    #region Accounting Allocation Record DTOs

    /// <summary>
    /// Request to create/update an accounting allocation record
    /// </summary>
    public class AccountingAllocationRequest
    {
        public string? FieldId { get; set; }
        public string? PoolId { get; set; }
    ...
    /// <summary>
    /// Request to create/update a royalty calculation record
    /// </summary>
    ...
    /// <summary>
    /// Request to create/update a cost allocation record
    /// </summary>
    ...
    #region Accounting Record DTOs (for tables that may not exist in PPDM models)

    /// <summary>
    /// Accounting allocation record (DTO - used when PPDM model class doesn't exist)
    /// </summary>
    public class ACCOUNTING_ALLOCATION
    {
    ...
    /// <summary>
    /// Royalty calculation record (DTO - used when PPDM model class doesn't exist)
    /// </summary>
    ...
    /// <summary>
    /// Cost allocation record (DTO - used when PPDM model class doesn't exist)
    /// </summary>
    public class COST_ALLOCATION
    {
