...
namespace Beep.OilandGas.PPDM39.Core.DTOs
{
    ...
    /// <summary>
    /// Extended connection configuration with organization context and audit fields
    /// Extends ConnectionConfig to add setup-specific metadata
    /// </summary>
    public class DatabaseConnectionSetupData : ConnectionConfig
    {
        /// <summary>
        /// Organization ID this connection is associated with
        /// </summary>
        public string? OrganizationId { get; set; }

        /// <summary>
        /// User ID who performed the setup
        /// </summary>
        public string? SetupUserId { get; set; }

        /// <summary>
        /// Timestamp when the setup was performed
        /// </summary>
        public DateTime? SetupTimestamp { get; set; }

        /// <summary>
        /// Whether this is the default connection for the organization
        /// </summary>
