...
namespace Beep.OilandGas.Models.Data.Calculations
{
    public class EconomicAnalysisResult : ModelEntityBase
    {
        ...
        // ── Best-practice additions (SPE PRMS §6.2 economic evaluation) ───────────

        // DISCOUNT_RATE: rate used for NPV — must be disclosed per SPE PRMS §6.2
        ...
        // NPV10: NPV at 10% discount rate — industry-standard O&G metric (SPEE guideline)
        private decimal? NPV10Value;
        public decimal? NPV10
        {
            get { return this.NPV10Value; }
            set { SetProperty(ref NPV10Value, value); }
        }

        // CURRENCY: ISO 4217 code (USD/GBP/EUR) for all monetary values in this result
        ...
        // RESERVES_CATEGORY: 1P / 2P / 3P — links result to reserves basis (SPE PRMS §2.1)
        private string? RESERVES_CATEGORYValue;
        public string? RESERVES_CATEGORY
        {
