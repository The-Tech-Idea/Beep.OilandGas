...
| 1 | [.plans/01_Phase_Contracts_And_Persistence.md](.plans/01_Phase_Contracts_And_Persistence.md) | Done — **`FormatIdForTable`** on LifeCycle/API IDs; **OCE** propagation |
| 2 | [.plans/02_Phase_Numerics_Validation_And_Units.md](.plans/02_Phase_Numerics_Validation_And_Units.md) | Done — README units; **`FlashValidator`** finite checks; service validates before flash |
...
| 4 | [.plans/04_Phase_API_And_Orchestration.md](.plans/04_Phase_API_And_Orchestration.md) | Done — **`FlashEquationOfStateMapping`**, **`EosModelReferenceCode`**, **`COMPONENT_NAME`** on LifeCycle feed map |
| 5 | [.plans/05_Phase_Tests_And_Verification.md](.plans/05_Phase_Tests_And_Verification.md) | Done — LOV/module/merge/RR + **EOS mapping** + **binary golden** tests |
...
| Done | Golden vector — **`FlashIsothermalFlashGoldenVectorTests`** (binary C1/C2 vs external Wilson+RR reference) |
