...
namespace Beep.OilandGas.EnhancedRecovery.Data;

/// <summary>
/// Extension reference list for enhanced-recovery LOVs (method categories, screening tags).
/// Seeded by <c>EnhancedRecoveryModule</c> during database setup.
/// </summary>
public partial class R_ENHANCED_RECOVERY_REFERENCE_CODE : ModelEntityBase
{
